...
4. 장르 선택 (판타지/로맨스/무협/현대/미스터리/재난/소설 작법/마스터 플롯) → 소재 선택 (108개) — **마스터 플롯**은 토비어스 《작가를 위한 20가지 플롯》 기반으로 탐구·모험·추격·구출·탈출·복수·수수께끼·라이벌·약자의 역전·유혹·변신·전환·성숙·사랑·금지된 사랑·희생·발견·탐닉의 과실·승천·추락을 소재화
