...
export async function syncCytoscapeFromNodes() {
  if (!state.cy) return;
...
export async function updateNodeImage(name, url) {
...
export async function uploadNodeImage(name, file) {
...
export async function saveNodeWiki(name) {
  const n = state.nodes.get(name);
  if (n) {
...
export async function updateNodeOverlays() {
...
export async function toggleNodeOverlay(nid) {
